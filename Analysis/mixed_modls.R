...
plot_model(m_FEve, type = "pred", terms = c( "Macrophyte_biomass"),  show.data=F, 
           jitter = 0, 
           title = "", dot.alpha=0.8, line.size=0.1, 
...
plot_model(m_FDiv, type = "pred", terms = c( "Water_PC1"),  show.data=F, 
           jitter = 0, 
           title = "", dot.alpha=0.8, line.size=0.1, 
...
plot_model(m_FDiv, type = "pred", terms = c( "Macrophyte_biomass"),  show.data=F, 
           jitter = 0, 
           title = "", dot.alpha=0.8, line.size=0.1, 
...
plot_model(m_FDis, type = "pred", terms = c( "Water_PC3"),  show.data=F, 
           jitter = 0, 
           title = "", dot.alpha=0.8, line.size=0.1, 
